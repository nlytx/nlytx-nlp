...
class DiscreteMarginal2[V1<:VectorVar,V2<:VectorVar](val _1:V1, val _2:V2, proportions2:Proportions2 = null) extends DiscreteMarginal with Marginal2 {
  ...
  def incrementCurrentValue(w:Double): Unit = (_1,_2) match {
    case (d1:DiscreteVar,d2:DiscreteVar) => proportions.masses.+=(d1.intValue, d2.intValue, w);
    case d:(V1,V2) => throw new Error("Not yet implemented") }
...
class DiscreteMarginal3[V1<:VectorVar,V2<:VectorVar,V3<:VectorVar](val _1:V1, val _2:V2, val _3:V3, proportions3:Proportions3 = null) extends DiscreteMarginal {
  ...
  def incrementCurrentValue(w:Double): Unit = (_1,_2,_3) match { case (d1:DiscreteVar,d2:DiscreteVar,d3:DiscreteVar) => proportions.masses.+=(d1.intValue, d2.intValue, d3.intValue, w); case d:(V1,V2,V3) => throw new Error("Not yet implemented") }
  def setToMaximize(implicit d:DiffList): Unit = throw new Error("Not yet implemented")
}
...
class DiscreteMarginal4[V1<:VectorVar,V2<:VectorVar,V3<:VectorVar,V4<:VectorVar](val _1:V1, val _2:V2, val _3:V3, val _4:V4, proportions4:Proportions4 = null) extends DiscreteMarginal {
  ...
  def incrementCurrentValue(w:Double): Unit = (_1,_2,_3,_4) match { case (d1:DiscreteVar,d2:DiscreteVar,d3:DiscreteVar,d4:DiscreteVar) => proportions.masses.+=(d1.intValue, d2.intValue, d3.intValue, d4.intValue, w); case d:(V1,V2,V3,V4) => throw new Error("Not yet implemented") }
  def setToMaximize(implicit d:DiffList): Unit = throw new Error("Not yet implemented")
}
